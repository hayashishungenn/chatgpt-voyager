...
const STYLE_ID = 'chatgpt-voyager-quote-reply-style';
...
function injectStyles() {
  ...
  style.textContent = `
    ...
    /* Check for specific theme attributes if the host uses them */
...
function getChatInput(): HTMLElement | null {
  // ChatGPT usually uses a textarea (prompt-textarea)
...
export function startQuoteReply() {
  ...
  function handleQuoteClick() {
    ...
    if (input) {
      ...
      console.warn('[ChatGPT Voyager] Could not find chat input.');
    }
  }
  ...
  function handleSelectionChange() {
    ...
    setTimeout(() => {
      ...
      // ChatGPT uses <main>. We want to avoid nav, sidebar, etc.
