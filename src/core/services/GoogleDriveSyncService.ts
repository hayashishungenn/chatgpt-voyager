 ...
 * - chatgpt-voyager-folders.json
 * - chatgpt-voyager-prompts.json
 */
...
const FOLDERS_FILE_NAME = 'chatgpt-voyager-folders.json';
const PROMPTS_FILE_NAME = 'chatgpt-voyager-prompts.json';
const BACKUP_FOLDER_NAME = 'ChatGPT Voyager Data';
