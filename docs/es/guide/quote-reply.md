...
ChatGPT Voyager ofrece una conveniente función de "Respuesta con Cita", haciendo que responder a contenido específico sea más preciso y eficiente.
...
1. **Selecciona y Cita**: En la página de conversación (ya sea tu pregunta o la respuesta de ChatGPT), selecciona cualquier texto con el ratón.
...
- **Formato Estándar**: Utiliza la sintaxis universal de Markdown, que ChatGPT entiende perfectamente, permitiendo respuestas más precisas.
...
- **Preguntar Detalles**: Selecciona un concepto poco claro en la respuesta de ChatGPT, haz clic en citar y luego escribe "Por favor, explica este concepto en detalle".
