...
يجعل ChatGPT Voyager من السهل جداً إعادة استخدام الصيغ الرياضية والرموز العلمية. وهو يدعم النسخ بنقرة واحدة لكود مصدر LaTeX وتنسيق MathML المتوافق مع Microsoft Word.

## مقدمة

عندما تطلب من ChatGPT اشتقاق صيغ أو كتابة تعبيرات رياضية، فإنه عادة ما يعرضها باستخدام LaTeX. وبينما يبدو المظهر جميلاً، فإن استخراج كود المصدر لاستخدامه في أوراقك أو مستنداتك أو محرراتك الخاصة يتطلب غالباً جهداً يدوياً.
...
![نسخ الصيغ](/assets/ChatGPT-math-copy.png)
...
- **الكتابة الأكاديمية**: عند كتابة الأوراق البحثية في Word، اجعل ChatGPT يشتق الصيغ، ثم استخدم نسخ ولصق MathML لتجنب عناء الإدخال اليدوي في محرر معادلات Word.
