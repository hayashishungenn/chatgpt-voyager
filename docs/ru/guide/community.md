...
- **Обмен промптами**: Смотрите, как другие используют ChatGPT, и делитесь своими лучшими промптами.
...
- [Сообщить об ошибке](https://github.com/hayashishungenn/chatgpt-voyager/issues/new?template=bug_report.yml)
- [Предложить функцию](https://github.com/hayashishungenn/chatgpt-voyager/issues/new?template=feature_request.yml)

Спасибо за поддержку ChatGPT Voyager! ❤️
