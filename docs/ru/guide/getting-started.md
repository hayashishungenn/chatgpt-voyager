...
ChatGPT Voyager — это не просто утилита, это рабочий процесс. Вот как извлечь из него максимум пользы за первые 5 минут.

## 1. Настройка

Если вы еще не установили его, перейдите к [Руководству по установке](/ru/guide/installation).
После установки обновите вкладку ChatGPT. Вы сразу увидите разницу.
