...
Когда ChatGPT выдает блоки кода Mermaid (блок-схемы, диаграммы последовательности, диаграммы Ганта и т.д.), Voyager автоматически обнаруживает и рендерит их как интерактивные диаграммы.
...
1. Попросите ChatGPT сгенерировать любой код диаграммы Mermaid
