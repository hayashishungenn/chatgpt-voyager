...
ChatGPT Voyager предлагает удобную функцию "Ответ с цитированием", делающую ответы на конкретный контент более точными и эффективными.
...
1. **Выделите для цитирования**: Используйте мышь, чтобы выделить любой текст на странице разговора (будь то ваш вопрос или ответ ChatGPT).
...
- **Стандартный формат**: Использует универсальный синтаксис Markdown, который ChatGPT прекрасно понимает, что приводит к более точным ответам.
...
- **Уточняйте детали**: Выделите непонятное понятие в ответе ChatGPT, нажмите цитировать, а затем введите "Пожалуйста, объясните это понятие подробно."
