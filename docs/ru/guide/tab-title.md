...
Автоматически синхронизирует заголовок вкладки браузера с текущим заголовком чата ChatGPT.

## Особенности

- **Синхронизация в реальном времени**: Когда заголовок чата меняется (например, ИИ генерирует новый заголовок или вы вручную переименовываете его), заголовок вкладки браузера мгновенно обновляется с "ChatGPT" на конкретную тему разговора.
...
2. Откройте любой разговор ChatGPT и обратите внимание на заголовок вкладки браузера; он автоматически обновится в соответствии с заголовком чата.
3. Чтобы отключить:
