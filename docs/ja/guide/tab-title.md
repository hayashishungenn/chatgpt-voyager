...
ブラウザのタブタイトルを、現在の ChatGPT の会話タイトルと自動的に同期します。

## 機能紹介

- **リアルタイム同期**: 会話タイトルが変わると（AI が新しいタイトルを生成したり、手動でリネームした場合など）、タブの表示も「ChatGPT」だけではなく、すぐに会話タイトルへ更新されます。
...
2. 任意の ChatGPT 会話を開き、ブラウザのタブタイトルを確認してください。自動的に現在の会話タイトルに変わります。
3. オフにする場合：
