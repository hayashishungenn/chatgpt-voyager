...
hero:
  ...
  text: 'O sistema operativo que faltava ao ChatGPT.'
  tagline: 'Adoramos o ChatGPT. Só queríamos que fosse perfeito.'
  image:
    src: /logo.png
    alt: Logótipo do ChatGPT Voyager
  actions:
    - theme: brand
      text: Descarregar
...
teaser:
  ...
  description: 'Não queríamos criar apenas mais uma extensão. Queríamos criar uma melhor forma de pensar.<br>Quando usa o ChatGPT Voyager, deixa de lutar contra a interface e passa a fluir com ela.'
...
<div class="vp-doc" style="text-align: center; margin: 4rem auto 3rem; max-width: 780px; padding: 0 16px;">
  ...
  <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
    <img src="https://img.shields.io/github/stars/hayashishungenn/chatgpt-voyager?style=flat-square&logo=github" alt="Estrelas GitHub">
    <img src="https://img.shields.io/github/forks/hayashishungenn/chatgpt-voyager?style=flat-square&logo=github" alt="Forks GitHub">
    <img src="https://img.shields.io/github/v/release/hayashishungenn/chatgpt-voyager?style=flat-square&logo=github" alt="Último Lançamento">
    <img src="https://img.shields.io/github/downloads/hayashishungenn/chatgpt-voyager/total?style=flat-square&logo=github" alt="Downloads GitHub">
    ...
    <img src="https://img.shields.io/amo/users/chatgpt-voyager?style=flat-square&logo=firefox" alt="Utilizadores Firefox Add-ons">
    <img src="https://img.shields.io/amo/rating/chatgpt-voyager?style=flat-square&logo=firefox" alt="Avaliação Firefox Add-ons">
  </div>
...
<div class="vp-doc" style="text-align: center; margin: 4rem auto 3rem; max-width: 1000px; padding: 0 16px;">
  ...
  <div style="margin-top: 12px; display: flex; justify-content: center;">
    <a href="https://www.producthunt.com/posts/chatgpt-voyager" target="_blank" rel="noopener noreferrer"><img alt="ChatGPT Voyager no Product Hunt" width="250" height="54" src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1064704&amp;theme=light&amp;t=1768842096186"></a>
  </div>
</div>
