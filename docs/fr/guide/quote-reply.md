...
ChatGPT Voyager offre une fonctionnalité pratique de "Réponse avec Citation", rendant les réponses à un contenu spécifique plus précises et efficaces.
...
1. **Sélectionner pour Citer** : Utilisez votre souris pour sélectionner n'importe quel texte dans la page de conversation (que ce soit votre question ou la réponse de ChatGPT).
...
- **Format Standard** : Utilise la syntaxe Markdown universelle, que ChatGPT comprend parfaitement, menant à des réponses plus précises.
...
- **Approfondir les détails** : Sélectionnez un concept confus dans la réponse de ChatGPT, cliquez sur citer, puis tapez "Veuillez expliquer ce concept en détail."
