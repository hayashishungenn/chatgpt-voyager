...
ChatGPT Voyager facilite grandement la réutilisation de formules mathématiques et de symboles scientifiques. Il prend en charge la copie en un clic du code source LaTeX et du format MathML compatible avec Microsoft Word.

## Présentation

Lorsque vous demandez à ChatGPT de dériver des formules ou d'écrire des expressions mathématiques, il les affiche généralement en utilisant LaTeX. Bien que le rendu soit esthétique, l'extraction du code source pour l'utiliser dans vos propres articles, documents ou éditeurs nécessite souvent un effort manuel.
...
![Copie de Formules](/assets/ChatGPT-math-copy.png)
...
- **Rédaction Académique** : Lors de la rédaction d'articles dans Word, demandez à ChatGPT de dériver des formules, puis utilisez le copier-coller MathML pour éviter la saisie manuelle dans l'éditeur d'équations de Word.
