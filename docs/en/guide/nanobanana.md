...
Images generated by ChatGPT come with a visible watermark by default. While this is intended for safety, there are creative scenarios where you need a perfectly clean slate.
...
1. **Enable it**: Find "NanoBanana Option" at the end of the ChatGPT Voyager settings panel and toggle it on.
