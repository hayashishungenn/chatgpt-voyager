...
提示詞管理器現在可以在您選擇的任何網站上使用，不僅限於 ChatGPT 和 AI Studio。
...
3. 打開瀏覽器控制台（F12）查看 `[ChatGPT Voyager]` 日誌
...
目前，自定義網站上僅支持提示詞管理器。其他功能（時間線、資料夾等）是專門為 ChatGPT 和 AI Studio 設計的，在其他網站上無法使用。
