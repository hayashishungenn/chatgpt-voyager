import { d as getSettings, u as updateSettings } from "./storage-G_NSCLrW.js";
(function polyfill() {
...
function ToggleRow({ icon, label, desc, settingKey, settings, onChange }) {
  const value = settings[settingKey];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "setting-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "setting-label", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-icon", children: icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        label,
        desc && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-desc", children: desc })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "toggle", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "toggle-thumb" })
    ] })
  ] });
}
function App() {
  ...
  if (!settings) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", height: 200, color: "var(--text-muted)" }, children: "Loading…" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-title", children: "ChatGPT Voyager" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-version", children: "v1.0.0 • Active on chatgpt.com" })
      ] }),
      saved && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-badge", style: { marginLeft: "auto" }, children: "Saved ✓" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "Core Features" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "📂", label: "Folder Organization", desc: "Two-level folder hierarchy with drag-drop", settingKey: "enableFolders", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "💡", label: "Prompt Vault", desc: "Save & reuse prompts", settingKey: "enablePromptVault", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "📍", label: "Timeline Navigation", desc: "Visual message scroll nodes on the right", settingKey: "enableTimeline", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "💾", label: "Chat Export", desc: "Export as JSON, Markdown, or PDF", settingKey: "enableExport", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "AI Enhancements" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "📐", label: "Formula Copy", desc: "One-click LaTeX / MathML copy", settingKey: "enableFormulaCopy", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "🔬", label: "Deep Research", desc: "Extract reasoning & cited URLs", settingKey: "enableDeepResearch", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "🧜", label: "Mermaid Rendering", desc: "Auto-render Mermaid diagrams", settingKey: "enableMermaid", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "Power Tools" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "🗑️", label: "Batch Delete", desc: "Bulk delete conversations", settingKey: "enableBatchDelete", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "💬", label: "Quote Reply", desc: "Select text → Reply with context", settingKey: "enableQuoteReply", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "🔖", label: "Tab Title Sync", desc: "Sync tab title to conversation name", settingKey: "enableTabTitleSync", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "🛑", label: "Prevent Auto Scroll", desc: "Don't jump to bottom on Enter", settingKey: "enablePreventAutoScroll", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "📏", label: "Input Collapse", desc: "Auto-shrink textarea when idle", settingKey: "enableInputCollapse", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleRow, { icon: "👁️", label: "Hide Recents", desc: "Hide date-grouped Recent items", settingKey: "enableHideRecents", settings, onChange: handleToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "Preferences" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", style: { flexDirection: "column", alignItems: "flex-start", gap: 6 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "setting-label", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-icon", children: "🤖" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Default Model",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-desc", children: "Auto-select on new chats" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "setting-label", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "setting-icon", children: "📤" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Default Export Format" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "ChatGPT Voyager" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "footer-link", href: "https://github.com/Nagi-ovo/gemini-voyager", target: "_blank", rel: "noopener noreferrer", children: "Inspired by gemini-voyager ↗" })
    ] })
  ] });
}
const root = clientExports.createRoot(document.getElementById("root"));
root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}));
//# sourceMappingURL=popup.html-BzpSiuqj.js.map
